...
__attribute__((visibility("default"))) BinaryWord
BinaryWord¸fromCString(const char *str, uint32_t length) {
...
BinaryWord·toCString(BinaryWord value, uint32_t length) {
  if (length == 0 || length > 64) {
  ...
  if (!buffer)
    panic("Out of memory in BinaryLaneField.toCString");
...
__attribute__((visibility("default"))) TernaryWord
TernaryWord¸fromCString(const char *str, uint32_t length) {
  if (length == 0 || length > 64) {
...
__attribute__((visibility("default"))) char *
TernaryWord·toCString(TernaryWord value, uint32_t length) {
  if (length == 0 || length > 64) {
  ...
  char *buffer = malloc((size_t)length + 1);
  if (!buffer)
    panic("Out of memory in TernaryLaneField.toCString");

  for (uint32_t i = 0; i < length; i++) {
    BinaryWord bit = 1ULL << (length - 1 - i);
    TernaryWord b = (TernaryWord){.x0 = (value.x0 & bit) ? 1ULL : 0ULL,
...
__attribute__((visibility("default"))) TernaryWord
tritwiseAdjust__towards(TernaryWord a, TernaryWord b) {
  ...
  //   result == 0: (a == -1 && b == +1) || (a == 0 && b == 0) || (a == +1 && b
  //   == -1) result == +1: (a == 0 && b == +1) || (a == +1 && b != -1)
  //
  ...
  // result == 0
  BinaryWord res_0 =
      (a_is_m1 & b_is_p1) | (a_is_0 & b_is_0) | (a_is_p1 & b_is_m1);
  // result == +1
...
__attribute__((visibility("default"))) TernaryWord
tritwiseRotate__by(TernaryWord a, TernaryWord b) {
  ...
  // result == -1: (a == -1 && b == 0) || (a == 0 && b == -1) || (a == +1 && b
  // == +1)
  BinaryWord res_m1 =
      (a_is_m1 & b_is_0) | (a_is_0 & b_is_m1) | (a_is_p1 & b_is_p1);
  // result == 0: (a == -1 && b == +1) || (a == 0 && b == 0) || (a == +1 && b ==
  // -1)
  BinaryWord res_0 =
      (a_is_m1 & b_is_p1) | (a_is_0 & b_is_0) | (a_is_p1 & b_is_m1);
  // result == +1: (a == -1 && b == -1) || (a == 0 && b == +1) || (a == +1 && b
  // == 0)
  BinaryWord res_p1 =
      (a_is_m1 & b_is_m1) | (a_is_0 & b_is_p1) | (a_is_p1 & b_is_0);
...
__attribute__((visibility("default"))) TernaryWord
tritwiseModulate__by(TernaryWord a, TernaryWord b) {
  // Canonical encoding: 00 = -1, 01 = 0, 11 = +1
  BinaryWord a0 = a.x0, a1 = a.x1, b0 = b.x0, b1 = b.x1;
  BinaryWord a_is_m1 = ~(a0 | a1);
  BinaryWord a_is_0 = (a0 & ~a1);
  ...
  // result == -1: (a == -1 && b == +1) || (a == 0 && b == 0) || (a == +1 && b
  // == -1)
  BinaryWord res_m1 =
      (a_is_m1 & b_is_p1) | (a_is_0 & b_is_0) | (a_is_p1 & b_is_m1);
  // result == 0: (a == 0) || (b == 0)
