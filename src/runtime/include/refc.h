...
typedef const struct __data_type_info {
  /// @brief The size of the memory payload for allocations of this type
  /// including __rc_header
  const size_t size;
...
/// @param __ext_size__ additional size to allocate after the structure for
...
/// @param structure the memory structure
#define releaseRC(__var__)                                                     \
  _release_rc_structure(__var__);                                              \
  __var__ = NULL
...
#define releaseProxy(__var__)                                                  \
  _release_proxy(__var__);                                                     \
  __var__ = NULL

#define RC_HEADER(structure) ((__rc_header *)structure)
